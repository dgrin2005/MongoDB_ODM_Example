...
public class MainClass {
    public static void main(String[] args) {
        System.out.println("MONGODB ODM EXAMPLE");
    ...
    private static void workWithDB(DataSetDAO dbService) throws MongoODMException {
        ...
        dbService.create(address1);
        dbService.create(address2);
        dbService.create(address3);
        dbService.create(address4);
